...
const Announcement = () => {
  ...
  return (
    <div
      className={`bg-indigo-600 ${hiddenAnnouncement ? "" : "hidden"}   w-full`}
    >
      <div className="px-3 py-3 mx-auto max-w-7xl ">
        <div className="flex flex-wrap items-center">
          <div className="flex items-center flex-1 w-0">
            ...
            <p className="ml-3 font-medium text-white ">
              <span className="hidden lg:inline   text-[20px]">
                {" "}
                For a short time, there is no shipping fee for purchases of 100$
                or more!{" "}
              </span>
              <span className="lg:hidden">
                No shipping fee for purchases of 100$ or more!{" "}
              </span>
            </p>
          </div>
          ...
          <div className="flex-shrink-0 order-2 sm:order-3 sm:ml-3">
            <button
              onClick={() => {
                setHiddenAnnouncement(!hiddenAnnouncement);
              }}
              type="button"
